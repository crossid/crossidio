...
const navigation = {
  ...
  social: [
    ...
    {
      name: 'Linkedin',
      href: 'https://www.linkedin.com/company/crossid',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    },
    {
      ...
      icon: (props: any) => <Icon icon="github" color="gray" {...props} />,
    },
    // {
    //   name: 'Dribbble',
    //   href: '#',
...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-slate-900" aria-labelledby="footerHeading">
      ...
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            /> */}
            <Logo kind="grayscale" />
            <p className="text-base text-gray-500">Identity, seamlessly.</p>
