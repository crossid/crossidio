...
const fallbackTheme = themes[2]

function LightIcon(props: any): JSX.Element {
  return (
...
export function ThemeSelector(props: any) {
  ...
  return (
    ...
    >
      ...
      >
        <LightIcon className="hidden h-4 w-4 fill-indigo-400 dark:fill-sky-400 [[data-theme=light]_&]:block" />
