...
function LoginBox() {
  return (
    // <div className="rounded-xl bg-white py-4 shadow-xl ring-1 ring-slate-900/5 dark:bg-slate-800 dark:highlight-white/10">
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                autoComplete="email"
                required
                className="form-input block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 dark:border-slate-600 dark:bg-slate-800 sm:text-sm"
              />
            </div>
          </div>
        ...
        <div className="mt-6">
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-gray-300 dark:border-slate-500" />
            </div>
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            <div>
              <a
                href="#"
                className="hover:bg-gray inline-flex w-full cursor-default justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-500 shadow-sm dark:border-slate-600  dark:bg-slate-700 dark:text-slate-500"
              >
