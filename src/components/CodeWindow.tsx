...
import { ForwardedRef, forwardRef, Fragment, LegacyRef, ReactNode, useMemo } from 'react'
import tokenize from '../macros/tokenize.macro'
import { Code } from './Code'
import styles from './CodeWindow.module.css'

const { tokens: defaultTokens } = tokenize.html(`<div>specify tokens</div>`)
  ...
  (
    {
      ...
      initialLineNumber,
      ...props
    }: { tokens: any; initialLiber: number; initialLineNumber: number; [x: string]: any },
...
export function getClassNameForToken({ types, empty }: Line) {
