        ...
        <div className="relative py-16 bg-white overflow-hidden">
          <div className="relative px-4 sm:px-6 lg:px-8">
            <div className="text-lg max-w-prose mx-auto">
              ...
              <p className="mt-8 text-xlleading-8">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">Definitions</h2>
              ...
              <ul>
                ...
                <li>
                  ...
                  in this Agreement) refers to Indexia Technologies, Gilad 4, Ramat Gan.
                </li>
                <li>
                ...
                <li>
                  ...
                  regarding the use of the Service. This Terms and Conditions agreement as been
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">Acknowledgement</h2>
              <p className="pb-2">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">Links to Other Websites</h2>
              <p className="pb-2">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">Termination</h2>
              <p className="pb-2">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">Limitation of Liability</h2>
              <p className="pb-2">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">Governing Law</h2>
              <p className="pb-2">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">Disputes Resolution</h2>
              <p className="pb-2">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">For European Union (EU) Users</h2>
              <p className="pb-2">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">United States Legal Compliance</h2>
              <p className="pb-2">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">Severability and Waiver</h2>
              <h3 className="text-1xl pb-2 mt-2 font-extrabold">Severability</h3>
              <p className="pb-2">
              ...
              <h3 className="text-1xl pb-2 mt-2 font-extrabold">Waiver</h3>
              <p className="pb-2">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">Translation Interpretation</h2>
              <p className="pb-2">
              ...
              <h2 className="text-2xl pb-2 mt-2 font-extrabold">Email Us</h2>
              <p className="pb-2">
