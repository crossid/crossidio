            ...
            <div className="mx-auto max-w-prose text-lg">
              ...
              <ul>
                ...
                <li>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Indexia
                  Technologies, Gilad 4, Ramat Gan.
                </li>
                <li>
                ...
                <li>
                  ...
                  Service. This Terms and Conditions agreement as been created
                  with the help of{' '}
                ...
                <li>
                  <strong>Website</strong> refers to CrossID, accessible from
                  crossid.io
                </li>{' '}
                <li>
              ...
              <h3 className="text-1xl mt-2 pb-2 font-extrabold">
                Severability
              </h3>
              <p className="pb-2">
