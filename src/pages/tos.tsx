        ...
        <div className="relative overflow-hidden py-16">
          <div className="relative px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-prose text-lg">
              ...
              <p className="text-xlleading-8 mt-8">
                Please read these terms and conditions carefully before using Our Service.
              </p>
              <h3 className="mb-5 mt-5">Interpretation and Definitions</h3>
              <p className="">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">Definitions</h2>
              ...
              <ul>
                ...
                <li>
                  ...
                  Indexia Technologies, Gilad 4, Ramat Gan.
                </li>
                <li>
                ...
                <li>
                  ...
                  Company regarding the use of the Service. This Terms and Conditions agreement as
                ...
                <li>
                  <strong>Website</strong> refers to CrossID, accessible from crossid.io
                </li>{' '}
                <li>
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">Acknowledgement</h2>
              <p className="pb-2">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">Links to Other Websites</h2>
              <p className="pb-2">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">Termination</h2>
              <p className="pb-2">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">Limitation of Liability</h2>
              <p className="pb-2">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">Governing Law</h2>
              <p className="pb-2">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">Disputes Resolution</h2>
              <p className="pb-2">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">For European Union (EU) Users</h2>
              <p className="pb-2">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">United States Legal Compliance</h2>
              <p className="pb-2">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">Severability and Waiver</h2>
              <h3 className="text-1xl mt-2 pb-2 font-extrabold">Severability</h3>
              <p className="pb-2">
              ...
              <h3 className="text-1xl mt-2 pb-2 font-extrabold">Waiver</h3>
              <p className="pb-2">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">Translation Interpretation</h2>
              <p className="pb-2">
              ...
              <h2 className="mt-2 pb-2 text-2xl font-extrabold">Email Us</h2>
              <p className="pb-2">
              ...
              <ul>
                <li>
                  By email:{' '}
                  <a className="text-indigo-500 dark:text-sky-500" href={`mailto:${email}`}>
                    {email}
                  </a>
                </li>
              </ul>
