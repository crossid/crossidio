      ...
      <div className="px-4 sm:px-6 md:px-8">
        ...
        <div className="relative mx-auto max-w-5xl pt-20 sm:pt-24 lg:pt-32">
          ...
          <div className="mt-6 flex justify-center space-x-6 text-sm sm:mt-10">
            ...
            <Link
              href="/contact"
              className="hidden h-12 w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-6 font-semibold text-slate-900 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 dark:border-slate-700 dark:bg-slate-400 dark:highlight-white/20 dark:hover:bg-slate-300 dark:focus:ring-slate-800 dark:focus:ring-offset-slate-300 sm:w-auto md:flex"
            >
              Request demo
            </Link>
            {/* <GetStarted/> */}
