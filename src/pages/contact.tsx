...
function Form() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    fetch('/', {
      ...
      //   TODO
      //   .catch((error) => add('Error while submitting form: ' + error))
      .finally(() => {
        setInSubmit(false)
      })
              ...
              >
                ...
                <div>
                  <button
                    ...
                    //
                    className={clsx(
                      'inline-flex justify-center py-3 px-6 border-transparent text-sm leading-4 font-bold rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500',
